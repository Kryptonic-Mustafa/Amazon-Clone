        ...
        <div className="h-fit space-y-6">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div className="border-t border-dashed border-gray-200 pt-6 space-y-3">
              <div className="flex justify-between text-gray-600"><span>Subtotal</span><span className="font-medium">${checkoutTotal.toFixed(2)}</span></div>
              ...
              <div className="flex justify-between items-center pt-4 border-t border-gray-100 mt-2"><span className="text-lg font-bold text-gray-900">Total to Pay</span><span className="text-2xl font-bold text-blue-600">${checkoutTotal.toFixed(2)}</span></div>
            </div>
          </div>
